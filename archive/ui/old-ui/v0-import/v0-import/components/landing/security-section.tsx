...
export function SecuritySection() {
  ...
  return (
    <section id="why" ref={sectionRef} className="relative py-24 lg:py-32 bg-foreground/[0.02] overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          {whyFeatures.map((feature, index) => (
            <div
              key={feature.title}
              className={`relative p-8 border rounded-2xl transition-colors duration-300 cursor-pointer h-[320px] overflow-hidden ${
                activeFeature === index
