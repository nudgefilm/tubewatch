        ...
        <div className="p-6 overflow-y-auto max-h-[calc(80vh-80px)] text-sm text-muted-foreground leading-relaxed space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li><strong>서비스:</strong> TubeWatch™가 제공하는 유튜브 채널 분석, 성장 전략 추천, 데이터 기반 인사이트 제공 서비스</li>
          ...
          <section>
            ...
            <p className="mb-2">TubeWatch™는 다음 데이터를 활용합니다.</p>
            <ul className="list-disc list-inside space-y-1 ml-2">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>TubeWatch™는 데이터 분석 기반 인사이트를 제공하는 서비스입니다.</li>
              <li>서비스에서 제공되는 분석 및 전략은 성장 결과를 보장하지 않습니다.</li>
              <li>이용자는 서비스 결과를 참고 자료로 활용해야 합니���.</li>
            </ul>
          </section>
