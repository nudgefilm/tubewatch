...
const descriptionOptimization = {
  ...
  firstLineImportance:
    "검색 결과와 추천 영상에서 첫 1~2줄만 노출되므로 핵심 내용을 반드시 포함해야 합니다.",
} as const
...
type RecommendationType = "warning" | "info" | "success"
...
function getTagSize(size: TagSize): string {
  switch (size) {
    case "large":
...
function SEOScoreCard(): JSX.Element {
  return (
...
function KeywordAnalysisCard(): JSX.Element {
...
function TitleOptimizationCard(): JSX.Element {
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center gap-3">
...
function DescriptionOptimizationCard(): JSX.Element {
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center gap-3">
...
function TagAnalysisCard(): JSX.Element {
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center gap-3">
...
function RecommendationsCard(): JSX.Element {
  return (
...
function SeoEmptyState(): JSX.Element {
  return (
...
export default function SeoLabPage(): JSX.Element {
  return (
