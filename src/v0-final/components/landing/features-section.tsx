...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full p-6 lg:p-8 border border-foreground/10 rounded-2xl hover:border-foreground/20 transition-colors duration-300">
        {/* Number */}
        <div className="mb-4">
        ...
        <div className="flex-1">
          <h3 className="text-2xl lg:text-3xl font-display mb-3 group-hover:translate-x-1 transition-transform duration-500">
            {feature.title}
          </h3>
        ...
        <div className="flex justify-center mt-6">
          <div className="w-40 h-32 text-foreground">
