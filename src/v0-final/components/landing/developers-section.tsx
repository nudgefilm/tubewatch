...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @tubewatch/sdk

# or
yarn add @tubewatch/sdk
pnpm add @tubewatch/sdk`,
  },
  {
    label: "Initialize",
    code: `import { TubeWatch } from '@tubewatch/sdk'

const tubewatch = new TubeWatch({
  apiKey: process.env.TUBEWATCH_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const app = await tubewatch.deploy({
  name: 'my-app',
  region: 'auto',
  scaling: {
    min: 1,
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-6 text-sm">
              <a href="/channels" className="text-foreground hover:underline underline-offset-4">
                Read the docs
              </a>
              <span className="text-foreground/20">|</span>
              <a href="/channels" className="text-muted-foreground hover:text-foreground">
                View on GitHub
              </a>
            </div>
          </div>
