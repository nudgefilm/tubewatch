...
import { normalizeChannelInput } from '@/lib/channels/parseChannelRegistrationInput'
    ...
    <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      <form onSubmit={handleSubmit}>
        <div className="flex gap-2">
          <div className="flex min-w-0 flex-1 overflow-hidden rounded-lg border border-gray-300 bg-white focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
            <span
              className="shrink-0 select-none border-r border-gray-200 bg-gray-50 px-2.5 py-2.5 text-sm text-gray-500"
              aria-hidden
            >
              https://
            </span>
            <input
              ...
              placeholder="www.youtube.com/@채널명"
              className="min-w-0 flex-1 border-0 bg-transparent px-2 py-2.5 text-sm text-gray-900 outline-none placeholder:text-gray-400"
