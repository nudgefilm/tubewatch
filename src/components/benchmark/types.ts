...
export type BenchmarkCompareItem = {
...
export type BenchmarkPageData = {
  ...
  selectedChannel: BenchmarkChannel | null;
  latestResult: BenchmarkResultRow | null;
  compareItems: BenchmarkCompareItem[];
  summaries: string[];
};

/**
 * getBenchmarkPageData / buildBenchmarkItemsFromResult에서 사용하는 분석 결과 행 타입.
 */
