  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl space-y-6 p-6 lg:p-8">
        ...
        {/* A. SEO 진단 */}
        <SeoLabDiagnosticSection />

        {/* B. 키워드 분석 */}
        <SeoLabKeywordAnalysisSection />

        {/* C. 제목 구조 개선 */}
        <SeoLabTitleOptimizationSection />

        {/* D. 주제 클러스터 */}
        <SeoLabTopicClusterSection />

        {/* F. 시각화 */}
        <SeoLabVisualizationSection />
