...
videos   최근 50개 수집 중...
signals  30개 데이터 시그널 · 9개 성장 지표 · 7개 채널 운영 패턴 체크 중...
...
✓  데이터 수집 완료`,
  },
  {
    number: "2",
    title: "데이터 분석",
    description: "영상 50개와 채널 데이터를\n30개 데이터 시그널 · 9개 성장 지표 · 7개 채널 운영 패턴으로 분석합니다.",
    code: `// 튜브워치 엔진 분석 중...
주제 일관성    ████████░░  82%
SEO 최적화    █████░░░░░  51%
시청자 반응    ███████░░░  74%
          ...
          <div className="space-y-0">
            {steps.map((step, index) => (
              <button
                ...
                className={`w-full text-left py-8 border-b border-background/10 transition-all duration-500 group cursor-pointer ${
