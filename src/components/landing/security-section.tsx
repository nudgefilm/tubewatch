...
const whyFeatures = [
  {
    ...
    description: "조회수·구독자 변화 그래프가 아닙니다. 최근 영상 50개와 채널 활동 데이터를 30개 데이터 시그널 · 9개 성장 지표 · 7개 채널 운영 패턴으로 종합해 채널이 왜 지금 이 상태인지를 진단합니다.",
    stats: ["최근 영상 50개 데이터 분석", "30개 데이터 시그널 분석", "9개 성장 지표 점수화", "7개 채널 운영 패턴 감지"],
