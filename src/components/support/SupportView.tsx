...
export default function SupportView() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "전문가 데이터 컨설팅은 TubeWatch 분석 데이터를 바탕으로 전문 컨설턴트가 채널 성장 전략 리포트와 함께 직접 진단해드리는 프리미엄 서비스입니다.\n신청은 [내 채널] 페이지의 '전문가 컨설팅 신청' 버튼을 통해 접수할 수 있으며, 채널 전략 리포트 전용 URL과 함께 전문가 진단 보고서가 정기 발행됩니다.\n사용자 플랜과 무관하게 신청할 수 있습니다.",
    },
    {
