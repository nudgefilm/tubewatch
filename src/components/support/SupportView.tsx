...
export default function SupportView() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "[내 채널] 페이지의 '월간 리포트 신청' 버튼을 통해 AI가 작성한 종합 채널 분석 리포트를 받아볼 수 있습니다.\n채널 현황·성과 지표·콘텐츠 전략까지 하나의 문서로 정리해 드리며, 생성에는 약 1~2분이 소요됩니다.\n채널당 30일에 1회 생성할 수 있으며, 이미 생성된 리포트가 있으면 '리포트 확인' 버튼으로 바로 열람할 수 있습니다.",
    },
    {
      question: "Channel DNA는 무엇인가요?",
      answer:
        "내 채널의 성과 패턴과 고유 구조를 분석하는 기능입니다.\n강점·약점 패턴, 영상 포맷 분포, 팬덤 응집도 등 채널 DNA를 진단하고 성장 방향을 파악할 수 있습니다.\nCreator·Pro 플랜에서 이용할 수 있습니다.",
    },
    {
      question: "Action Plan은 어떻게 활용하나요?",
      answer:
        "채널 분석 결과를 바탕으로 TubeWatch 엔진이 자동 생성한 실행 과제 목록입니다.\n우선순위별로 정렬된 액션 항목과 각 항목의 근거·실행 시나리오를 참고해 콘텐츠 전략에 바로 적용할 수 있습니다.",
    },
    {
