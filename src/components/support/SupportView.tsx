...
export default function SupportView() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Free 플랜은 채널 1개, Creator 플랜은 최대 3개, Pro 플랜은 최대 10개를 등록할 수 있습니다. Free 플랜은 만료 없이 영구적으로 1개 채널만 이용 가능합니다.",
    },
    {
      question: "등록한 채널을 바꿀 수 있나요?",
      answer:
        "Creator·Pro 구독 중에는 채널을 변경할 수 있습니다. 각 채널은 월 1회 변경이 가능하며, Creator(3채널) 기준 한 달에 최대 6개 채널을 분석할 수 있습니다. Free 플랜 및 구독 만료 후에는 채널 변경이 제한됩니다.",
    },
    {
      question: "구독이 만료되면 데이터는 어떻게 되나요?",
      answer:
        "구독 만료 시 기존 분석 데이터와 채널은 그대로 유지됩니다. 단, 채널 추가·삭제 등 변경은 불가하며, DNA·Action Plan·Next Trend 등 유료 메뉴는 접근이 제한됩니다. 재구독하면 즉시 모든 기능이 복원됩니다.",
    },
    {
      question: "탈퇴하면 데이터는 어떻게 되나요?",
      answer:
        "탈퇴 시 분석 데이터와 채널 정보는 즉시 영구 삭제되며 복구할 수 없습니다. 같은 Google 계정으로 재가입해도 기존 데이터는 연동되지 않습니다. 단, 결제·구독 이력은 전자상거래법에 따라 5년간 보관 후 파기됩니다.",
    },
    {
      question: "플랜을 다운그레이드하면 채널은 어떻게 되나요?",
      answer:
        "Pro → Creator 다운그레이드 시 등록 채널이 3개를 초과하면 오래된 채널부터 삭제됩니다. 다운그레이드는 현재 구독 만료 후 적용되므로, 그 전에 채널 목록을 직접 정리하는 것을 권장합니다.",
    },
    {
      question: "Channel DNA는 무엇인가요?",
      answer:
        "Channel DNA는 내 채널의 성과 패턴을 분석하는 기능입니다. 강점·약점 패턴, 영상 포맷 분포, 팬덤 응집도 등 채널 고유의 구조를 진단합니다. Creator·Pro 플랜에서 이용할 수 있습니다.",
    },
    {
      question: "Action Plan은 어떻게 활용하나요?",
      answer:
        "채널 분석 결과를 바탕으로 튜브워치 엔진이 자동 생성한 실행 과제 목록입니다. 우선순위별로 정렬된 액션 항목을 확인하고, 각 항목의 근거와 실행 시나리오를 참고해 콘텐츠 전략에 적용하세요.",
    },
    {
      question: "플랜을 변경하거나 구독하려면 어떻게 하나요?",
      answer:
        "Billing 페이지에서 플랜을 선택해 구독할 수 있습니다. 튜브워치 구독은 자동 갱신 없이 선택한 기간(월간·6개월) 만료 시 종료되는 안심 구독 방식입니다. 업그레이드는 즉시 적용되며, 다운그레이드는 현재 구독 만료 후 적용됩니다.",
    },
    {
