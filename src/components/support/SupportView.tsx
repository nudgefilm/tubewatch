...
export default function SupportView() {
  const faqs = [
    ...
    {
      question: "전문가 데이터 컨설팅은 무엇인가요?",
      answer:
        "전문가 데이터 컨설팅은 TubeWatch 분석 데이터를 바탕으로 전문 컨설턴트가 1:1로 채널 성장 전략을 직접 제안해드리는 프리미엄 서비스입니다.\n자동화된 리포트와 달리, 채널의 방향성·콘텐츠 전략·수익화 방안 등 맞춤형 인사이트를 제공합니다.\n신청은 [내 채널] 페이지의 '전문가 컨설팅 신청' 버튼을 통해 접수할 수 있으며, 일정 조율 후 화상 또는 문서 형태로 진행됩니다.\nPro 플랜 사용자에게 우선 배정되며, Creator 플랜 이상 구독자도 신청할 수 있습니다.",
    },
    {
