...
interface ActionCallContextValue {
  ...
  trigger: (content: ActionCallContent, channelTitle?: string | null) => void
}
...
export function ActionCallProvider({
  ...
  const [content, setContent] = useState<ActionCallContent | null>(null)
  ...
  const trigger = useCallback(
    (c: ActionCallContent, ct?: string | null) => {
